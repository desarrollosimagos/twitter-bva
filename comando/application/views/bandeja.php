...
<html lang="en">
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    <li class="xn-logo">
                        <a href="#">PUESTO DE COMANDO ARAGUA</a>
            ...
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <div class="mb-content">
                        ...
                        <input type="radio" class="iradio" id="tipo" name="tipo" value="politico"> Político 
                        <input type="radio" id="tipo" class="iradio" name="tipo" value="asistencial"> Asistencial </p>                    
                        <p>Observaciones</p>
        ...
        <div class="message-box animated fadeIn" id="mb-buscando">
            ...
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <div class="mb-footer">
                        <div class="pull-right">
                            <a id="enlace4" class="btn btn-default btn-lg mb-control-close" onclick='asociarcuenta();'>Registrar cuenta como Boots</a>
                            <button class="btn btn-default btn-lg mb-control-close">Cancelar</button>
                        </div>
                    </div>
                </div>
    ...
    <script>
    	...
    	$.post( "<?php echo base_url();?>index.php/welcome/asignarboots", { usuario: usuario, cedula:cedula },function( data ) {
            		location.reload();
				},'json');
	    $("#cedula").val('');
    	$('#usuario').text('');
