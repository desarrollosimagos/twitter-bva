                                    ...
                                    <div class="wizard show-submit">                                
                                        ...
                                        <div id="step-5">   
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" id="cedula" name="cedula" class="form-control" value="<?php echo $cedula; ?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" id="centro" name="centro" class="form-control" value="<?php echo $centro; ?>"/>
                                                </div>
                                            </div> 
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Direccion del Centro</label>
                                                <div class="col-md-10">
                                                    <input type="text" id="dir_centro" name="dir_centro" class="form-control" value="<?php echo $dir_centro; ?>"/>
                                                </div>
                                            </div> 
