                                    ...
                                    <div class="wizard show-submit">                                
                                        ...
                                        <div id="step-5">   
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Genero</label>
                                                <div class="col-md-10">
                                                    <input type="text" id="sexo" name="sexo" class="form-control" value=""/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Centro de Votacion</label>
                                                <div class="col-md-10">
                                                    <input type="text" id="centro" name="centro" class="form-control" value=""/>
                                                </div>
                                            </div> 
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Direccion del Centro</label>
                                                <div class="col-md-10">
                                                    <input type="text" id="dir_centro" name="dir_centro" class="form-control" value=""/>
                                                </div>
                                            </div> 
                                            <?php } ?>
                                        </div>
