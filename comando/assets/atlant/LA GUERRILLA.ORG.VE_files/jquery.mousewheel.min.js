...
<p>
    ...
    La URL de la <a href="http://localhost/twitteros/">p&aacute;gina que le ha remitido</a> 
    parece ser err&oacute;nea o estar obsoleta. Por favor, informe del error 
    al autor de <a href="http://localhost/twitteros/">esa
    p&aacute;gina</a>.
...
<address>
  ...
  <span>Apache/2.4.18 (Unix) OpenSSL/1.0.2g PHP/5.6.19 mod_perl/2.0.8-dev Perl/v5.16.3</span>
</address>
</body>
</html>
