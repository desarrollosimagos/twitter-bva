...
(function() {
    // The raw lexicon.
    var newLex = {"An unknown error occurred.":"Se produjo un error desconocido.","Click to close.":"Haga clic para cerrar.","Password strength must be at least [numf,_1].":"La seguridad de la contraseña debe ser al menos [numf,_1].","Passwords must be at least [quant,_1,character,characters] long.":"Las contraseñas deben tener una longitud de al menos [quant,_1,caracter,caracteres,caracteres,caracteres,caracteres,caracteres].","Success!":"¡Éxito!","The API response could not be parsed.":"No se pudo analizar sintácticamente la respuesta de API."};
