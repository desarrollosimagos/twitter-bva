...
<form id='form_organos' action="" method="POST">
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default fondo_trans">
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-4">
                <input maxlength="300" autofocus="autofocus" id="nom_ins" style="width: 100%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese la institución" name="nom_ins" type="text" class="form-control" />
            </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-4" style="margin-left: 5%">
                <input maxlength="26" id="tlf" style="width: 90%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ejemplo: 0426-1234567/0243-12345678" name="tlf" type="text" class="form-control" />
            </div>
        </div>
        <div class="panel-body">
            <div class="col-xs-1" >Cargo</div>
            <div class="col-xs-4">
                <input maxlength="50" id="cargo" style="width: 100%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese el cargo" name="cargo" type="text" class="form-control" />
            </div>
         ...
         <div class="panel-body">
            ...
            <div class="col-xs-4">
                <input maxlength="300" id="correo" style="width: 100%;" placeholder="INGRESE EL CORREO" name="correo" type="text" class="form-control" />
            </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-11">
                <textarea onblur="javascript:this.value = this.value.toUpperCase();" style="width:97%" id="direccion" name="direccion" rows="3" cols="50" class="form-control"></textarea>
            </div>
        </div>
        <br/>
