...
<script>
    $(document).ready(function () {
        ...
        $('#nom_ins,#siglas,#nom_resp,#cargo').alpha({allow: " -.()/,"});
        ...
        $("#registrar").click(function (e) {
            ...
            if ($('#nom_ins').val().trim() == '') {
                ...
                bootbox.alert("Rellene el campo de Institución", function () {
                    ...
                    $("#nom_ins").parent('div').addClass('has-error');
                    $("#nom_ins").focus();
                });
...
<form id='form_organos' action="" method="POST">
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default fondo_trans">
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-4">
                <input maxlength="300" autofocus="autofocus" id="nom_ins" value="<?php echo $data->nom_ins ?>" style="width: 100%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese la institución" name="nom_ins" type="text" class="form-control" />
            </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-4" style="margin-left: 5%">
                <input id="tlf" value="<?php echo $data->tlf ?>" style="width: 90%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ejemplo: 0426-1234567/0243-12345678" name="tlf" type="text" class="form-control" />
            </div>
        </div>
        <div class="panel-body">
            <div class="col-xs-1" >Cargo</div>
            <div class="col-xs-4">
                <input maxlength="50" id="cargo" value="<?php echo $data->cargo ?>" style="width: 100%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese el cargo" name="cargo" type="text" class="form-control" />
            </div>
            ...
            <div class="col-xs-5" style="margin-left: 3%">
                <select id='sector' name="sector" class="form-control" style="width: 106%">
                    ...
                    foreach ($list_sector as $value) {
                        ?>
                        <option value="<?php echo $value->id; ?>"><?php echo $value->codigo." / "; echo $value->sector; ?></option>
                        <?php
                    }
                    ?>
                </select>
         ...
         <div class="panel-body">
            ...
            <div class="col-xs-4">
                <input maxlength="300" id="correo" value="<?php echo $data->correo ?>" style="width: 100%;" placeholder="Ingrese el correo" name="correo" type="text" class="form-control" />
            </div>
            ...
            <div class="col-xs-5" style="margin-left: 3%">
                <select id='tipo_estructura' name="tipo_estructura" class="form-control" style="width: 106%">
                    ...
                    foreach ($estructura as $value) {
                        ?>
                        <option value="<?php echo $value->id; ?>"><?php echo $value->codigo." / "; echo $value->estructura; ?></option>
                        <?php
                    }
                    ?>
                </select>
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-11">
                <textarea onblur="javascript:this.value = this.value.toUpperCase();" style="width:97%" id="direccion" name="direccion" rows="3" cols="50" class="form-control"><?php echo $data->direccion ?></textarea>
            </div>
        </div>
        <br/>
