...
<script>
    $(document).ready(function () {
        ...
        $("#registrar").click(function (e) {
            ...
            if ($('#estatus').val().trim() == '') {
                ...
                $.post('<?php echo base_url(); ?>acciones/observaciones/ControllersObservacionesProy/guardar', $('#form_observaciones_proyecto').serialize(), function (response) {
                    ...
                    if (response == "existe") {
                        bootbox.alert("Disculpe, ya se encuentra registrado la estructura n° " + $("#estructura").val() + ", verifique los datos", function () {
                            $('.nav-tabs a[href=#tabs_observacion]').tab('show');
                        }).on('hidden.bs.modal', function (event) {
                            $("#estructura").parent('div').addClass('has-error');
                            $("#estructura").focus();
                        ...
                        bootbox.alert("Se registro con exito", function () {
                            ...
                            url = '<?php echo base_url(); ?>acciones/observaciones/ControllersObservacionesProy/procesar/' + $("#id_accion").val() + '';
                            window.location = url;
                        });
                    }
                });
        ...
        $("#organo").change(function () {
            ...
            $.post('<?php echo base_url(); ?>acciones/observaciones/ControllersObservacionesProy/ajax_search/' + organo + '', function (response) {
                var option = "";
        ...
        $("#id_accion").change(function () {
            ...
            //sub_estructura = response['estructura'].substring(0,9);
            /*alert(estructura);
            alert(sub_estructura);*/
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-8">
                <div style="float: left;">
                    <input type="text" id="ano_fiscal" disabled="" placeholder="0000" class="form-control" style='width: 70%;'/>
                </div>
                <div style="float: left;">
        ...
        <div class="tab-content">
            <div id="tabs_observacion" class="tab-pane fade in active">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-10">
                        <div style="float: left;">
                            <input placeholder="00-00-00-00" type="text" id="estructura" name="estructura" placeholder="0000" class="form-control" style='width: 90%;'/>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
