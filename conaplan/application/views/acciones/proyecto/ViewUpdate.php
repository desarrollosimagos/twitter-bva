...
<script>
    $(document).ready(function () {
        ...
        $("#registrar").click(function (e) {
            ...
            } else if ($('#responsable').val().trim() == '') {
                bootbox.alert("Ingrese el Responsable", function () {
                    $('.nav-tabs a[href=#tabs_identificacion]').tab('show');
                }).on('hidden.bs.modal', function (event) {
                    $("#responsable").parent('div').addClass('has-error');
                    $("#responsable").focus();
                });
        ...
        $("#ente").change(function () {
            ...
            $.post('<?php echo base_url(); ?>acciones/proyecto/ControllersProyecto/search_table/id/organos_entes/' + ente + '', function (response) {
                ...
                $("#responsable").val(response[0]['nom_resp']);
        ...
        $("#registrar_acc_esp").click(function (e) {
            ...
            if ($('#acc_esp').val().trim() == '') {
                ...
                if ($("#id_act").val() == "") {
                    ...
                    $.post('<?php echo base_url(); ?>acciones/proyecto/ControllersProyecto/cargar/2/' + $("#codigo").val() + '', $('#form_acciones_especificas').serialize(), function (response) {
                    ...
                    var id = $("#id_act").val();
                    $.post('<?php echo base_url(); ?>acciones/proyecto/ControllersProyecto/cargar/3/' + id + '', $('#form_carga_tarea').serialize(), function (response) {
        ...
        <div class="tab-content">
            <div id="tabs_identificacion" class="tab-pane fade in active">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-4">
                        <input maxlength="25" readonly id="cargo" value="<?=$row->cargo?>" style="width: 100%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese el cargo" name="cargo" type="text" class="form-control" />
                    </div>
                    <div class="col-xs-1">1.6 Teléfono</div>
                    <div class="col-xs-4">
                        <input maxlength="15" readonly id="tlf" value="<?=$row->tlf?>" style="width: 65%;" placeholder="Ingrese el teléfono" name="tlf" type="text" class="form-control" />
                    </div>
                </div>
                <div class="panel-body">
                    <div class="col-xs-2" >1.4 Responsable</div>
                    <div class="col-xs-4">
                        <input maxlength="25" readonly id="responsable" value="<?=$row->responsable?>" style="width: 100%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese el responsable" name="responsable" type="text" class="form-control" />
                    </div>
                    <div class="col-xs-1">1.7 Correo</div>
                    <div class="col-xs-4">
                        <input id="correo" readonly value="<?=$row->correo?>" style="width: 65%;" placeholder="Ingrese el correo" name="correo" type="text" class="form-control" />
                    </div>
                </div>
                ...
                <div class="tab-content">
                    <div id="tabs_datos_proyecto" class="tab-pane fade in active">
                        <div class="panel-body">
                            ...
                            <div class="col-xs-9">
                                <input id="nom_proyecto" value="<?=$row->nom_proyecto?>" name="nom_proyecto" class="form-control" style='width: 96.5%;text-transform:uppercase;' onblur="javascript:this.value = this.value.toUpperCase();"/>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="col-xs-2" >Descripción del Proyecto</div>
                            <div class="col-xs-9">
                                <textarea rows="1.5" id='descripcion_proy' name='descripcion_proy' style='width: 96%;text-transform:uppercase;' onblur="javascript:this.value = this.value.toUpperCase();" class="form-control"><?=$row->descripcion_proy?></textarea>
                            </div>
                        </div>
                        <div class="panel-body">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-xs-4">
                                <input readonly="" maxlength="4" id="ano_fiscal" style="width: 20%;" placeholder="0000" name="ano_fiscal" type="text" class="form-control" />
                            </div>
            ...
            <div id="tabs_area_estrategico" class="tab-pane fade">
                ...
                <div class="tab-content">
                    <div id="tabs_plan_patria" class="tab-pane fade in active">
                        ...
                        <div class="panel-body">
                            <div class="col-xs-2" >4.1.4 Objetivo General</div>
                            <div class="col-xs-8">
                ...
                <div class="tab-content">
                    <div id="tabs_problema_justificacion" class="tab-pane fade in active">
                        <div class="panel-body">
                            ...
                            <div class="col-xs-8">
                                <textarea rows="4" maxlength="450" id="desc_problema" style="width: 96%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese la descripción del problema" name="desc_problema" type="text" class="form-control"><?=$row->desc_problema?></textarea>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="col-xs-2" >5.2 Objetivo General</div>
                            <div class="col-xs-8">
                                <textarea rows="4" maxlength="450" id="obj_general" style="width: 96%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese el Objetivo General" name="obj_general" type="text" class="form-control"><?=$row->obj_general?></textarea>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="col-xs-2" >5.3 Importancia e Impacto</div>
                            <div class="col-xs-8">
                                <textarea rows="4" maxlength="450" id="imp_impacto" style="width: 96%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese la Importancia e Impacto" name="imp_impacto" type="text" class="form-control"><?=$row->imp_impacto?></textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            foreach ($distribucion_acc as $value) {
                                ...
                                <tr style="font-size: 16px;font-size: 8px;" id="tr_<?php echo $value->id; ?>">
                                    ...
                                    <td style='text-align: left;width: 50%'>
                                        <textarea style="height: 50px;width: 100%;text-transform:uppercase" class="form-control capturar" id='acc_esp_<?=$value->id?>' name='<?=$value->id?>' onblur="javascript:this.value = this.value.toUpperCase();"><?php echo $value->acc_esp; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea style="height: 38px;text-transform:uppercase" class="form-control capturar" id='unidad_medida_<?=$value->id?>' name='<?=$value->id?>' onblur="javascript:this.value = this.value.toUpperCase();"><?php echo $value->unidad_medida; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea style="height: 38px;text-transform:uppercase" class="form-control capturar" id='medio_verificacion_<?=$value->id?>' name='<?=$value->id?>' onblur="javascript:this.value = this.value.toUpperCase();"><?php echo $value->medio_verificacion; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea style="height: 38px;width: 120px;" class="form-control capturar numeric" id='trimestre_i_<?=$value->id?>' name='<?=$value->id?>'><?php echo $value->trimestre_i; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea style="height: 38px;width: 120px;" class=" form-control capturar numeric" id='trimestre_ii_<?=$value->id?>' name='<?=$value->id?>'><?php echo $value->trimestre_ii; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea style="height: 38px;width: 120px;" class=" form-control capturar numeric" id='trimestre_iii_<?=$value->id?>' name='<?=$value->id?>'><?php echo $value->trimestre_iii; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea style="height: 38px;width: 120px;" class=" form-control capturar numeric" id='trimestre_iv_<?=$value->id?>' name='<?=$value->id?>'><?php echo $value->trimestre_iv; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea readonly="" style="height: 38px;width: 120px;color: red;" class=" form-control capturar" id='total_<?=$value->id?>' name='<?=$value->id?>'><?php echo $value->total; ?></textarea>
                                    </td>
                                </tr>
                                <?php
                                $i = $i + 1;
            ...
            <div id="tabs_observaciones" class="tab-pane fade">
                <div class="panel-body">                    
                    ...
                    <div class="col-xs-4">
                        <input id="fecha_revision" <?php if ($row->fecha_revision == "") { ?> value="" <?php } else { ?> value="<?php $fecha = explode('-', $row->fecha_revision); echo $fecha[2]."/".$fecha[1]."/".$fecha[0] ?>" <?php } ?> style="width:33%;text-transform:uppercase" placeholder="Fecha de revisión" readonly="" type="text" class="form-control" />
                    </div>
                </div>
                <div class="panel-body">                    
...
<form id='form_acciones_especificas' action="" method="POST" style='display: none;'>
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default fondo_trans">
        <div class="panel-heading" style='background: linear-gradient(#2F9292, #3B7272);color:#FFFFFF;' >
            <label>Registrar Acción Específica</label>
            <br>
        </div>
        ...
        <br/>
        <div class="row" style="text-align: center">
            <input type="submit" id="registrar_acc_esp" style="font-weight: bold;font-size: 13px" class="btn btn-danger" value="Guardar cambios"/>
        </div>
        <br/>
    </div>
</form>
...
<form id='form_imp_pres' action="" method="POST" style='display: none;'>
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default fondo_trans">
        ...
        <br/>
        <div class="row" style="text-align: center">
            <input type="submit" id="registrar_imp_pres" style="font-weight: bold;font-size: 13px" class="btn btn-danger" value="Guardar cambios"/>
        </div>
        <br/>
    </div>
</form>
