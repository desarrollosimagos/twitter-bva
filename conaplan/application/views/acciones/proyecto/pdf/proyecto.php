...
$this->pdf->SetFont('Arial', '', 8);
$this->pdf->Cell(44.5, 7, $this->ModelStandard->format_fecha('-',$row->inicio)." / ".$this->ModelStandard->format_fecha('-',$row->fin), 'TBR', 0, 'L', '1');
$this->pdf->SetFont('Arial', 'B', 8);
...
$this->pdf->SetFont('Arial', '', 8);
$this->pdf->Cell(22.5, 7, utf8_decode($etapa), 'TBR', 1, 'L', '1');
$this->pdf->SetFont('Arial', 'B', 8);
...
$this->pdf->SetFont('Arial', '', 8);
$this->pdf->Cell(148, 7, utf8_decode(strtoupper($row->indicador_g)), 'TBR', 1, 'L', '1');
$this->pdf->SetFont('Arial', 'B', 8);
...
$this->pdf->Ln(7);
$this->pdf->SetFont('Arial', '', 8);
$this->pdf->MultiCell(180, 4, utf8_decode($objetivo_general->objetivo_general), 'LR', 'J', 0);
$this->pdf->SetFont('Arial', 'B', 9);
$this->pdf->SetTextColor(255, 255, 255);  # COLOR DEL TEXTO
$this->pdf->SetFillColor(56, 119, 119);
...
$this->pdf->Ln(7);
$this->pdf->SetFont('Arial', '', 8);
$this->pdf->MultiCell(180, 4, utf8_decode($row->imp_impacto), 'LR', 'J', 0);
$this->pdf->SetTextColor(255, 255, 255);  # COLOR DEL TEXTO
$this->pdf->SetFillColor(56, 119, 119);
$this->pdf->SetFont('Arial', 'B', 10);
...
$this->pdf->Cell(100, 7, $req_acciones, 'TBR', 1, 'L', '1');
$this->pdf->SetFont('Arial', 'B', 8);
...
$this->pdf->Cell(93, 7, $con_acciones, 'TBR', 1, 'L', '1');
$this->pdf->SetFont('Arial', 'B', 8);
$this->pdf->Cell(25, 7, utf8_decode('7.2.1. Institución:'), 'TBL', 0, 'L', '1');
$this->pdf->SetFont('Arial', '', 8);
$this->pdf->Cell(155, 7, $con_instituciones, 'TBR', 1, 'L', '1');
$this->pdf->SetFont('Arial', 'B', 8);
$this->pdf->Cell(25, 7, utf8_decode('7.2.2. Explique:'), 'TBL', 0, 'L', '1');
$this->pdf->SetFont('Arial', '', 8);
$this->pdf->Cell(155, 7, $row->con_especifique, 'TBR', 1, 'L', '1');
$this->pdf->SetFont('Arial', 'B', 8);
...
foreach ($acc_es_fin as $row) {
    ...
    $this->pdf->Cell(17.5, 5, $this->pdf->Format_number($row->trimestre_i), 'TBLR', 0, 'C', '1');
    $this->pdf->Cell(17.5, 5, $this->pdf->Format_number($row->trimestre_ii), 'TBLR', 0, 'C', '1');
    $this->pdf->Cell(17.5, 5, $this->pdf->Format_number($row->trimestre_iii), 'TBLR', 0, 'C', '1');
    $this->pdf->Cell(17.5, 5, $this->pdf->Format_number($row->trimestre_iv), 'TBLR', 0, 'C', '1');
    $this->pdf->Cell(17, 5, $this->pdf->Format_number($row->total), 'TBLR', 1, 'C', '1');
...
$this->pdf->SetTextColor(0, 0, 0);  # COLOR DEL TEXTO
$this->pdf->SetFillColor(255, 255, 255);
$this->pdf->Cell(17.5, 5, $this->pdf->Format_number($trimestre_ip), 'TBLR', 0, 'C', '1');
$this->pdf->Cell(17.5, 5, $this->pdf->Format_number($trimestre_iip), 'TBLR', 0, 'C', '1');
$this->pdf->Cell(17.5, 5, $this->pdf->Format_number($trimestre_iiip), 'TBLR', 0, 'C', '1');
$this->pdf->Cell(17.5, 5, $this->pdf->Format_number($trimestre_ivp), 'TBLR', 0, 'C', '1');
...
foreach ($partida_presupuestaria as $row) {
    ...
    $this->pdf->SetTextColor(0, 0, 0);  # COLOR DEL TEXTO
    $this->pdf->SetFillColor(255, 255, 255);
    $this->pdf->Cell(5, 5, $row->codigo, 'TL', 0, 'C', '1');
    $this->pdf->Cell(88, 5, utf8_decode($row->partida_presupuestaria), 'TBR', 0, 'L', '1');
    $this->pdf->Cell(17.5, 5, $this->pdf->Format_number($row->trimestre_i), 'TBLR', 0, 'C', '1');
    $this->pdf->Cell(17.5, 5, $this->pdf->Format_number($row->trimestre_ii), 'TBLR', 0, 'C', '1');
    $this->pdf->Cell(17.5, 5, $this->pdf->Format_number($row->trimestre_iii), 'TBLR', 0, 'C', '1');
    $this->pdf->Cell(17.5, 5, $this->pdf->Format_number($row->trimestre_iv), 'TBLR', 0, 'C', '1');
    $this->pdf->Cell(17, 5, $this->pdf->Format_number($row->cantidad), 'TBLR', 1, 'C', '1');
...
$this->pdf->SetTextColor(0, 0, 0);  # COLOR DEL TEXTO
$this->pdf->SetFillColor(255, 255, 255);
$this->pdf->Cell(17.5, 5, $this->pdf->Format_number($trimestre_iimp), 'TBLR', 0, 'C', '1');
$this->pdf->Cell(17.5, 5, $this->pdf->Format_number($trimestre_iipimp), 'TBLR', 0, 'C', '1');
$this->pdf->Cell(17.5, 5, $this->pdf->Format_number($trimestre_iiipimp), 'TBLR', 0, 'C', '1');
$this->pdf->Cell(17.5, 5, $this->pdf->Format_number($trimestre_ivpimp), 'TBLR', 0, 'C', '1');
$this->pdf->Cell(17, 5, $this->pdf->Format_number($montopimp), 'TBLR', 1, 'C', '1');

// Salida del Formato PDF

$this->pdf->Output("Proyecto-$codigo $organismo ($ano).pdf", 'I');