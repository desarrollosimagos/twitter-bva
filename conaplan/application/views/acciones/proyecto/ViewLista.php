                    ...
                    <tr style="font-size: 16px" class="{% cycle 'impar' 'par' %}">
                        ...
                        <td style='text-align: center'>
                            <?php if($value->estatus == 1 or $value->estatus == 3){?>
                                <a href="<?php echo base_url('acciones/proyecto/ControllersProyecto/procesar_list/' . $value->codigo); ?>">
                                    <img style="width:25px;height: 25px" src="<?php echo base_url("assets/image/editar.png"); ?>"/>   
                                </a>
                            <?php }else{?>
                                <a style="text-decoration:none" href="<?php echo base_url('acciones/proyecto/ControllersProyecto/procesar_list/' . $value->codigo); ?>">
                                    <!--<img style="width:25px;height: 25px" src="<?php echo base_url("assets/image/editar.png"); ?>"/>   -->
                                    Ver
                                </a>
                            <?php }?>
