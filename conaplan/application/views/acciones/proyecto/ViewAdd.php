...
<script>
    $(document).ready(function () {
        ...
        $("#ente,#reg_registro").change(function () {
            var ente = $(this).val();
            $("#ente").select2('val',parseInt(ente));
        ...
        <div class="tab-content">
            <div id="tabs_identificacion" class="tab-pane fade in active">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-4">
                        <input maxlength="25" readonly id="cargo" style="width: 100%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese el cargo" name="cargo" type="text" class="form-control" />
                    </div>
                    <div class="col-xs-1">1.6 Teléfono</div>
                    <div class="col-xs-4">
                        <input maxlength="15" readonly id="tlf" style="width: 65%;" placeholder="Ingrese el teléfono" name="tlf" type="text" class="form-control" />
                    </div>
                </div>
                <div class="panel-body">
                    <div class="col-xs-2" >1.4 Responsable</div>
                    <div class="col-xs-4">
                        <input maxlength="25" readonly id="responsable" style="width: 100%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese el responsable" name="responsable" type="text" class="form-control" />
                    </div>
                    <div class="col-xs-1">1.7 Correo</div>
                    <div class="col-xs-4">
                        <input id="correo" readonly style="width: 65%;" placeholder="Ingrese el correo" name="correo" type="text" class="form-control" />
                    </div>
                </div>
                ...
                <div class="tab-content">
                    <div id="tabs_datos_proyecto" class="tab-pane fade in active">
                        <div class="panel-body">
                            ...
                            <div class="col-xs-9">
                                <input id="nom_proyecto" name="nom_proyecto" class="form-control" style='width: 96.5%;text-transform:uppercase;' onblur="javascript:this.value = this.value.toUpperCase();"/>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="col-xs-2" >Descripción del Proyecto</div>
                            <div class="col-xs-9">
                                <textarea rows="1.5" id='descripcion_proy' name='descripcion_proy' style='width: 96%;text-transform:uppercase;' onblur="javascript:this.value = this.value.toUpperCase();" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="panel-body">
                ...
                <div class="tab-content">
                    <div id="tabs_problema_justificacion" class="tab-pane fade in active">
                        <div class="panel-body">
                            ...
                            <div class="col-xs-8">
                                <textarea rows="4" maxlength="450" id="desc_problema" style="width: 96%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese la descripción del problema" name="desc_problema" type="text" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="col-xs-2" >5.2 Objetivo General</div>
                            <div class="col-xs-8">
                                <textarea rows="4" maxlength="450" id="obj_general" style="width: 96%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese el Objetivo General" name="obj_general" type="text" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="col-xs-2" >5.3 Importancia e Impacto</div>
                            <div class="col-xs-8">
                                <textarea rows="4" maxlength="450" id="imp_impacto" style="width: 96%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese la Importancia e Impacto" name="imp_impacto" type="text" class="form-control"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tabs_conexiones" class="tab-pane fade in">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-xs-5" style="margin-left:-15%">
                                <input id="acc_especifique" name="acc_especifique" style='width: 95%;' class="form-control" onblur="javascript:this.value = this.value.toUpperCase();"/>
                            </div>
                        </div>
                        <div class="panel-body">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-xs-5" style="margin-left:-15%">
                                <input id="con_especifique" name="con_especifique" style='width: 95%;' class="form-control" onblur="javascript:this.value = this.value.toUpperCase();"/>
                            </div>
                        </div>
                        <div class="panel-body">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-xs-5" style="margin-left:-15%">
                                <input id="en_especifique" name="en_especifique" style='width: 95%;' class="form-control" onblur="javascript:this.value = this.value.toUpperCase();"/>
                            </div>
                        </div>
                    </div>
