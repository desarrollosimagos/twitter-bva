...
foreach ($distrib_tri_fin as $row) {
    ...
    $this->pdf->SetTextColor(0, 0, 0);  # COLOR DEL TEXTO
    $this->pdf->SetFillColor(255, 255, 255);
    $this->pdf->Cell(36, 5, $this->pdf->Format_number($row->trimestre_i), 'TBLR', 0, 'C', '1');
    $this->pdf->Cell(36, 5, $this->pdf->Format_number($row->trimestre_ii), 'TBLR', 0, 'C', '1');
    $this->pdf->Cell(36, 5, $this->pdf->Format_number($row->trimestre_iii), 'TBLR', 0, 'C', '1');
    $this->pdf->Cell(36, 5, $this->pdf->Format_number($row->trimestre_iv), 'TBLR', 0, 'C', '1');
    $this->pdf->Cell(36, 5, $this->pdf->Format_number($row->total), 'TBLR', 1, 'C', '1');
...
$this->pdf->SetTextColor(255, 255, 255);  # COLOR DEL TEXTO
$this->pdf->SetFillColor(209, 153, 153);
$this->pdf->Cell(36, 5, $this->pdf->Format_number($trimestre_if), 'TBLR', 0, 'C', '1');
$this->pdf->Cell(36, 5, $this->pdf->Format_number($trimestre_iif), 'TBLR', 0, 'C', '1');
$this->pdf->Cell(36, 5, $this->pdf->Format_number($trimestre_iiif), 'TBLR', 0, 'C', '1');
$this->pdf->Cell(36, 5, $this->pdf->Format_number($trimestre_ivf), 'TBLR', 0, 'C', '1');
$this->pdf->Cell(36, 5, $this->pdf->Format_number($totalf), 'TBLR', 1, 'C', '1');
...
$this->pdf->Cell(78, 5, utf8_decode(''), 'BLR', 0, 'C', '1');
$this->pdf->SetTextColor(0, 0, 0);  # COLOR DEL TEXTO
$this->pdf->SetFillColor(191, 191, 191);
...
foreach ($imp_presupuestaria as $row) {
    ...
    $this->pdf->Cell(78, 5, utf8_decode($row->partida_presupuestaria), 'TBLR', 0, 'L', '1');
...
#$this->pdf->Image(base_url().'assets/image/logo_aragua.jpg',12,10,25);
