        ...
        <div class="tab-content">
            <div id="tabs_identificacion" class="tab-pane fade in active">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-4">
                        <input maxlength="20" id="cargo" readonly style="width: 65%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese el cargo" name="cargo" type="text" class="form-control" />
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    <div class="col-xs-4">
                        <input maxlength="11" id="tlf" readonly style="width: 65%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese el teléfono" name="tlf" type="text" class="form-control" />
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    <div class="col-xs-4">
                        <input maxlength="30" id="correo" readonly style="width: 65%;" placeholder="Ingrese el correo" name="correo" type="text" class="form-control" />
                    </div>
                </div>
            </div>
