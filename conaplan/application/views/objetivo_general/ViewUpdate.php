...
<form id="form_obj_general" action="" method="POST">
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default fondo_trans">
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-7">
                <textarea id="objetivo_general" name="objetivo_general" rows="4" cols="50" style="width: 130%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();"><?php echo $detalles_lista->objetivo_general;?></textarea> 
            </div>
        </div>
        <br/>
