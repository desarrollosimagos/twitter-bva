...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#group_id").select2('val',parseInt($("#id_group").val()));

        $("#permiso_ids").change(function (event) {
            var permiso = $("#permiso_ids").val();
            $("#permiso").val(permiso);
        });
            ...
            if ($('#cedula').val().trim() == '' || $('#cedula').val().trim() == 0) {
                ...
                $.post("<?php echo base_url(); ?>ControllersUser/guardar", $('#form_usuario_user').serialize(), function (response) {
                    ...
                    if (response == 'existe') {
                        ...
                        //return true;
                        bootbox.alert("Se modifico con exito", function () {
                        }).on('hidden.bs.modal', function (event) {
            ...
            <div class="panel-body">
                <div class="form-inline">
                    <div class="form-group col-xs-6">
                        <label>Cédula&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                        <input value="<?php echo $detalles_lista->cedula ?>" class="form-control" type='text' style="width:80%" placeholder="Ejemplo: 12345678" id="cedula" maxlength="8" name="cedula" autofocus='true'/>
                    </div>
                    <div class="form-group col-xs-6">
                        <label>&nbsp;&nbsp;Nombres&nbsp;</label>
                        <input value="<?php echo $detalles_lista->first_name ?>" class="form-control" style="width:83%" type='text' placeholder="Nombres" id="first_name" name="first_name"/>                           
                    </div>
                </div>
                <br/><br/><br/>
                <div class="form-inline">
                    <div class="form-group col-xs-6">
                        ...
                        <input value="<?php echo $detalles_lista->last_name ?>" class="form-control" style="width:80%" type='text' placeholder="Apellidos" id="last_name" name="last_name"/>
                    </div>
                    <div class="form-group col-xs-6">
                        <label>&nbsp;&nbsp;Usuario&nbsp;&nbsp;&nbsp;</label>
                        <input value="<?php echo $detalles_lista->username ?>" class="form-control" style="width:83%" type='text' placeholder="Usuario" id="username_id" name="username"/>
                    </div>
                </div>
                <br/><br/><br/>
                <div class="form-inline">
                ...
                <div class="form-inline">
                    ...
                    <div class="form-group col-xs-2" id='' style=''>
                        ...
                        <?php if($detalles_lista->agregar == 't'){
                         ?>
                         checked='checked'
                        <?php }?>
                        />
                    ...
                    <div class="form-group col-xs-2" id='' >
                        ...
                        <?php if($detalles_lista->modificar == 't'){
                         ?>
                         checked='checked'
                        <?php }?>
                        />
                    ...
                    <div class="form-group col-xs-2" id=''>
                        ...
                        <?php if($detalles_lista->eliminar == 't'){
                         ?>
                         checked='checked'
                        <?php }?>
                        />
                    ...
                    <div class="form-group col-xs-3" id=''>
                        ...
                        <?php if($detalles_lista->reporte == 't'){
                         ?>
                         checked='checked'
                        <?php }?>
                        />
...
<input id='id_group' type='hidden' value='<?php echo $detalles_lista->group_id; ?>'/>
