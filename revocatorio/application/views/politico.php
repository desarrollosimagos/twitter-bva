...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-default widget-item-icon" >
                                ...
                                <div class="widget-data">
                                    ...
                                    <div class="widget-title">Cooperante</div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-default widget-item-icon" >
                                ...
                                <div class="widget-data">
                                    ...
                                    <div class="widget-title">Oponente</div>
                            ...
                            <table class="table" id="tabla_solicitud">
                                ...
                                <tbody>
                                    ...
                                    <tr id="<?php echo $listado->id; ?>">
                                        ...
                                        <td><?php echo "<a href='vercuenta/".$listado->solicitante."' target='_blank'>".$listado->solicitante."</a>"; 
                                        ...
                                        <td><a href="#" class="mb-control2" data-box="#mb-identificar" onclick="identificar('<?php echo $listado->solicitante; ?>',this); return false;">
	                                    ...
	                                    ?>
                                        	<a href="#" class="mb-control2" data-box="#mb-respuestas" onclick="verRespuesta('<?php echo $listado->id; ?>',this,'<?php echo $listado->observacion2; ?>'); return false;">
											<span class="fa fa-sign-out"></span>Ver respuesta</a>
                                        <?php
                                        }
                                        ?>
                                        </td>
            ...
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <div class="mb-content">
                        ...
                        <input type="radio" class="iradio" id="tipo" name="tipo" value="cooperante"> Cooperante 
                        <input type="radio" id="tipo" class="iradio" name="tipo" value="oponente"> Oponente </p>                    
                        <p>Observaciones</p>
        ...
        <!-- MESSAGE BOX-->
        <div class="message-box animated fadeIn" id="mb-respuestas">
        
            <div class="mb-container">
                <div class="mb-middle">
                    <div class="mb-title"><span class="fa fa-comment-o"></span>Solicitud #<span id="solicitud2"></span></div>
                    <div class="mb-content">
                        <p>
    ...
    <script>
    	...
    	function verRespuesta(id,en,resp){
    		//alert('aqui');
    		var box = $($(en).data("box"));
    		
	    	$('#solicitud2').text(id);
	    	$('#respuesta_id').text(resp);
	    	//$('#'+id).attr('class', 'selected');
	    	box.toggleClass("open");
    	...
    	function actualizar_bandejas(){
    	   ...
    	   $.post( "<?php echo base_url();?>index.php/welcome/actualizarBandejas2", { id: ''},function( data ) {
				  $('#casos').text(data.casos);
			    $('#asignados').text(data.asignados);
			    $('#individual').text(data.individual);
			    $('#colectivo').text(data.colectivo);
    	...
    	function enviar(){
    		...
    		observacion = $('#observaciones').val();
			  ...
			  $.post( "<?php echo base_url();?>index.php/welcome/respuestapolitica", { id: id, tipo: tipo, observacion:observacion },function( data ) {
				    $('#casos').text(data.casos);
			        $('#asignados').text(data.asignados);
			        $('#individual').text(data.individual);
			        $('#colectivo').text(data.colectivo);
